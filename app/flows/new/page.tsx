...
const steps = [
  ...
  { id: 2, name: "Intro Greeting", component: StepIntroductionGreeting, dataKey: "stepIntroductionData" as keyof FlowData },
  { id: 3, name: "Questions", component: Step2Questions, dataKey: "step2Data" as keyof FlowData },
  { id: 4, name: "Conditional Logic", component: Step3ConditionalLogic, dataKey: "step3Data" as keyof FlowData },
  { id: 5, name: "Tool Calls", component: Step4ToolCalls, dataKey: "step4Data" as keyof FlowData },
  { id: 6, name: "Goodbye Greeting", component: StepGoodbyeGreeting, dataKey: "stepGoodbyeData" as keyof FlowData },
  { id: 7, name: "Review & Publish", component: Step5ReviewPublish, dataKey: "step5Data" as keyof FlowData },
];
    ...
    if (templateIdFromUrl) {
      ...
      if (selectedTemplate) {
        setFlowData(prev => ({
          ...prev,
          step1Data: {
            flowName: selectedTemplate.name, // Prefill flow name from template
          ...
          step2Data: {
            questions: selectedTemplate.questions.map(q => ({...q})) // Prefill questions, ensure to map to new objects
          },
          stepGoodbyeData: {
