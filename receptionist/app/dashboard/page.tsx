...
const mockFlows: { id: string; title: string; lastEdited: string; status: FlowStatus }[] = [
  { id: "1", title: "Client Intake Flow - Personal Injury", lastEdited: "2024-07-28", status: "Published" },
  { id: "2", title: "Internal QA Flow", lastEdited: "2024-07-25", status: "Draft" },
  { id: "3", title: "New Employee Onboarding", lastEdited: "2024-06-15", status: "Published" },
  { id: "4", title: "Lead Follow-up Automation", lastEdited: "2024-07-29", status: "Draft" },
  { id: "5", title: "Case Update Notification", lastEdited: "2024-07-20", status: "Published" },
];
    ...
    <div className="space-y-6">
      ...
      {mockFlows.length > 0 ? (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {mockFlows.map((flow) => (
            <FlowCard key={flow.id} title={flow.title} lastEdited={flow.lastEdited} status={flow.status} />
          ))}
        </div>
      ) : (
