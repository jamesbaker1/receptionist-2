...
export default function FlowCard({ title, lastEdited, status }: FlowCardProps) {
  return (
        ...
        <div className="flex justify-between items-start">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              <DropdownMenuItem>{/* TODO: Implement Edit action */}Edit</DropdownMenuItem>
              <DropdownMenuItem className="text-destructive hover:!text-destructive-foreground hover:!bg-destructive/90 dark:hover:!bg-destructive">
                {/* TODO: Implement Delete action */}Delete
              </DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
        </div>
