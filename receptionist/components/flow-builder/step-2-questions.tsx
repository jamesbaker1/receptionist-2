...
export default function Step2Questions({ onSubmit, initialData }: Step2QuestionsProps) {
  const [questions, setQuestions] = useState<QuestionFormValues[]>(initialData?.questions || []);
  ...
  const openNewQuestionModal = () => {
    setEditingQuestion(undefined); // Ensure it's a new question
    setIsModalOpen(true);
  };
